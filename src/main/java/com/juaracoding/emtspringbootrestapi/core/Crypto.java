package com.juaracoding.emtspringbootrestapi.core;
/*
IntelliJ IDEA 2023.2 (Community Edition)
Build #IC-232.8660.185, built on July 26, 2023
@Author EmiratZ a.k.a. M Emirat Millenium Try
Java Developer
Created on 31/08/2023 13.14
@Last Modified 31/08/2023 13.14
Version 1.0
*/
...
public class Crypto {
    ...
    public static void main(String[] args) {
        ...
        String strToDecrypt = encryptionResult;//put text to decrypt in here
